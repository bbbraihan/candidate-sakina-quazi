...
> **Submission notes:**
> - [delivery.md](delivery.md) — setup instructions, architecture decisions, and model choice rationale
> - [EVAL.md](EVAL.md) — evaluation report with retrieval, faithfulness, safety, and latency results
